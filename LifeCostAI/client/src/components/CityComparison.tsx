...
const cityData: CityData[] = [
  ...
  },
  {
    ...
    rentEstimate: { studio: 900, oneBed: 1300, twoBed: 1800 },
    transportCosts: { monthlyPass: 35, gasPerLiter: 1.35, rideshareBase: 5 },
    highlights: ["Rich cultural scene", "Excellent metro system", "Luxury shopping", "Winter sports"],
  },
  {
    name: "Santiago",
    country: "Chile",
    ...
    rentEstimate: { studio: 700, oneBed: 1000, twoBed: 1400 },
    transportCosts: { monthlyPass: 60, gasPerLiter: 1.45, rideshareBase: 4 },
    highlights: ["Modern infrastructure", "Wine country nearby", "Good weather", "Growing startup scene"],
  },
  {
    name: "Lima",
    country: "Peru",
    ...
    rentEstimate: { studio: 550, oneBed: 800, twoBed: 1200 },
